...
set output '../pic/u3.png'
set key fixed left top vertical Right noreverse enhanced autotitle box lt black linewidth 1.000 dashtype solid
unset parametric
set samples 10000000
set title "u(x,y) po 500 iteracjach metodą minimalizowania funkcjonału a" 
...
set cbrange [ -7 : 7 ] noreverse nowriteback
set rrange [ * : * ] noreverse writeback
set colorbox vertical origin screen 0.9, 0.2 size screen 0.05, 0.6 front  noinvert bdefault
NO_ANIMATION = 1
#plot [0:500] 'a.txt' with line
plot  '../output/u3.txt' with image 